...
from helpers.tick_helpers import (
    ...
    MARKET_TICK_FUNCTIONS, NATION_TICK_FUNCTIONS, NATION_CROSS_TICK_FUNCTIONS,
    ERA_NATION_TICK_FUNCTIONS, ERA_GENERAL_TICK_FUNCTIONS, ERA_CHARACTER_TICK_FUNCTIONS,
)
...
def tick_helper():
    ...
    TICK_FUNCTIONS.update(NATION_CROSS_TICK_FUNCTIONS)
...
@admin_required
def era_tick_helper():
    ERA_TICK_FUNCTIONS = ERA_GENERAL_TICK_FUNCTIONS.copy()
    ERA_TICK_FUNCTIONS.update(ERA_NATION_TICK_FUNCTIONS)
    ERA_TICK_FUNCTIONS.update(ERA_CHARACTER_TICK_FUNCTIONS)
